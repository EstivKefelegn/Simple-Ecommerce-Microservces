...
const file_proto_product_proto_rawDesc = "" +
	"\n" +
	"\x13proto/product.proto\x12\aproduct\"N\n" +
	...
	"\rcurrent_stock\x18\x02 \x01(\x05R\fcurrentStock2W\n" +
	"\x0eProductService\x12E\n" +
	"\n" +
	"CheckStock\x12\x1a.product.CheckStockRequest\x1a\x1b.product.CheckStockResponseB\x17Z\x15product-service/protob\x06proto3"
...
var file_proto_product_proto_goTypes = []any{
	(*CheckStockRequest)(nil),  // 0: product.CheckStockRequest
	(*CheckStockResponse)(nil), // 1: product.CheckStockResponse
}
var file_proto_product_proto_depIdxs = []int32{
	0, // 0: product.ProductService.CheckStock:input_type -> product.CheckStockRequest
	1, // 1: product.ProductService.CheckStock:output_type -> product.CheckStockResponse
